...
public class ObjectFactory {
    ...
    private final static QName _ConversionEuroTND_QNAME = new QName("http://service/", "conversionEuroTND");
    private final static QName _ConversionEuroTNDResponse_QNAME = new QName("http://service/", "conversionEuroTNDResponse");
     ...
     * 
     * @return
     *     the new instance of {@link ConversionEuroTND }
     */
     ...
     * 
     * @return
     *     the new instance of {@link ConversionEuroTNDResponse }
     */
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ConversionEuroTND }{@code >}
     */
    @XmlElementDecl(namespace = "http://service/", name = "conversionEuroTND")
    public JAXBElement<ConversionEuroTND> createConversionEuroTND(ConversionEuroTND value) {
        return new JAXBElement<>(_ConversionEuroTND_QNAME, ConversionEuroTND.class, null, value);
    }
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ConversionEuroTNDResponse }{@code >}
     */
    @XmlElementDecl(namespace = "http://service/", name = "conversionEuroTNDResponse")
    public JAXBElement<ConversionEuroTNDResponse> createConversionEuroTNDResponse(ConversionEuroTNDResponse value) {
        return new JAXBElement<>(_ConversionEuroTNDResponse_QNAME, ConversionEuroTNDResponse.class, null, value);
    }
